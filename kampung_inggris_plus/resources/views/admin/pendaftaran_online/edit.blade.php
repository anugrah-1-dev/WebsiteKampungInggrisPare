                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="pending" {{ $pendaftaran->status == 'pending' ? 'selected' : '' }}>
                                        Pending</option>
                                    <option value="approved" {{ $pendaftaran->status == 'diterima' ? 'selected' : '' }}>
                                        Approved (Diterima)</option>
                    ...
                    <div class="col-md-6">
                        ...
                        @if ($pendaftaran->bukti_pembayaran)
                            <a href="{{ asset('storage/' . $pendaftaran->bukti_pembayaran) }}" target="_blank">
                                <img src="{{ asset('storage/' . $pendaftaran->bukti_pembayaran) }}" alt="Bukti Pembayaran"

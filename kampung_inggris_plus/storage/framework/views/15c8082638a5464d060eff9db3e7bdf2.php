...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/arablandingpage.css')); ?>">
</head>
...
<body>
        ...
        <div class="carousel">
            <div class="slides">
                <div class="slide active">
                    <img src=<?php echo e(asset('asset/img/brilliantclass1.jpg')); ?> alt="Belajar Bahasa Arab 1">
                </div>
                <div class="slide">
                    <img src=<?php echo e(asset('asset/img/brilliantclass2.jpg')); ?> alt="Belajar Bahasa Arab 2">
                </div>
                <div class="slide">
                    <img src=<?php echo e(asset('asset/img/brilliantclass3.jpg')); ?> alt="Belajar Bahasa Arab 3">
                </div>
            </div>
    ...
    <section class="pamflet-section">
        <div class="container">
            ...
            <div class="pamflet">
                <img src=<?php echo e(asset('asset/img/ARABPAM.jpg')); ?> alt="Pamflet Program Brilliant Alsaeid">
            </div>
                        ...
                        <div class="program-card">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="card-text text-muted small mb-2">
                                    ...
                                    Kategori: <?php echo e($program->kategori ?? '-'); ?>
...
</html><?php /**PATH /home/u389110718/domains/biepluskampunginggris.com/kampung_inggris_plus/resources/views/Landingpage/arab.blade.php ENDPATH**/ ?>
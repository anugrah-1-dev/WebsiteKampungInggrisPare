...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/inggrislandingpage.css')); ?>">
    <!-- Bootstrap 5.3 CSS -->
        ...
        <div class="carousel">
            <div class="slides">
                <div class="slide active">
                    <img src="<?php echo e(asset('asset/img/brilliant1.jpg')); ?>" alt="Belajar Bahasa Arab 1">
                </div>
                <div class="slide">
                    <img src="<?php echo e(asset('asset/img/brilliant2.jpg')); ?>" alt="Belajar Bahasa Arab 2">
                </div>
                <div class="slide">
                    <img src="<?php echo e(asset('asset/img/brilliant3.jpg')); ?>" alt="Belajar Bahasa Arab 3">
                </div>
            </div>
                                        ...
                                        <ul class="list-unstyled d-inline-block text-start mb-0">
                                            <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fitur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="d-flex align-items-center mb-2">
                                                    ...
                                                    <span class="ms-2"><?php echo e(trim($fitur)); ?></span>
                                                </li>
                        ...
                        <div class="program-card">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="card-text text-muted small mb-2">
                                    ...
                                    Category: <?php echo e($program->kategori ?? '-'); ?>
...
@media (max-width: 768px) {
    .wave-divider {
        height: 80px; /* lebih pendek di layar kecil */
    }
    .wave-line svg {
        width: 180%; /* jangan terlalu melebar */
        height: 100px; /* lebih kecil */
    }
}
...
.hr-half {
    ...
    border-top: 2px solid #ccc; /* garis custom */
}
...
<?php /**PATH /home/u389110718/domains/biepluskampunginggris.com/kampung_inggris_plus/resources/views/Landingpage/inggris.blade.php ENDPATH**/ ?>
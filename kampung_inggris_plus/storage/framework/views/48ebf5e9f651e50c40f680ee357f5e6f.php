        ...
        <div class="card shadow">
            <div class="card-body">
                ...
                <div class="detail-box">
                    ...
                    <p><strong>Nama:</strong> <?php echo e($pendaftaran->nama_lengkap ?? '-'); ?></p>
                    <p><strong>Program:</strong> <?php echo e($pendaftaran->program->nama ?? '-'); ?></p>
                    <p class="mb-0">
                        <strong>Jumlah DP:</strong>
                        <?php if(isset($pendaftaran->program->harga_dp)): ?>
                            Rp <?php echo e(number_format($pendaftaran->program->harga_dp, 0, ',', '.')); ?>
                    ...
                    <?php if(isset($bank) && $bank): ?>
                        <li class="list-group-item d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <strong class="d-block"><?php echo e($bank->name); ?></strong>
                                    <span id="bank-number"><?php echo e($bank->number); ?></span> (a.n. <?php echo e($bank->owner); ?>)
                                </div>
                            </div>
                            <button class="btn btn-outline-secondary btn-sm copy-btn"
                                onclick="copyToClipboard('<?php echo e($bank->number); ?>', this)">
                ...
                <form action="<?php echo e(route('dp.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="pendaftaran_program_offline_id" value="<?php echo e($pendaftaran->id); ?>">

                    <div class="mb-4">
                        <label for="bukti_dp" class="form-label">Unggah Bukti Pembayaran</label>
                        <input type="file" name="bukti_dp" id="bukti_dp"
                            class="form-control <?php $__errorArgs = ['bukti_dp'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <button type="submit" class="btn btn-primary">
                          ...
                          <a href="<?php echo e(url('/')); ?>" class="btn btn-secondary"><i
                    ...
                    <div class="whatsapp-section">
                        ...
                        <?php
                            ...
                            $message = "Halo, saya ingin konfirmasi pembayaran DP untuk ID Transaksi: "
                                ...
                                . ".";
                        ?>
                        <a href="https://wa.me/<?php echo e($waNumber); ?>?text=<?php echo e(urlencode($message)); ?>" class="btn btn-success"
                            target="_blank">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u389110718/domains/biepluskampunginggris.com/kampung_inggris_plus/resources/views/pembayaran/dp.blade.php ENDPATH**/ ?>